...
console.log(`DeepSeek大模型通用调用: POST http://localhost:${PORT}/ai/deepseek`)
console.log(`股票数据AI分析: GET http://localhost:${PORT}/ai/stock-analysis`)
console.log(`生成弹幕内容: GET http://localhost:${PORT}/ai/generate-danmaku`)
